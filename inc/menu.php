    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-xs-4 col-sm-5 ">
                <div class="menu-categorias pull-left">
                    <a href="#" class="dropdown-categorias">Categorías </a>
                </div>
                <div class="menu-search pull-left hidden-xs">
...
<div class="menu-overlay-categorias">
    <div class="container">
        <div class="row">
             
                <div class="col-md-2">
                    <div class="titulo-menu">Baño</div>
                    <ul>
